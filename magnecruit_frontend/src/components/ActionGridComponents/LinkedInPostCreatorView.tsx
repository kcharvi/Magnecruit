...
import { ChevronDown, ChevronUp, Linkedin, Share2, RefreshCw } from "lucide-react";
...
const LinkedInPostCreatorView: React.FC<LinkedInPostCreatorViewProps> = () => {
    ...
    const generateLinkedInPost = async () => {
        ...
        try {
            // Make an API call to the CrewAI backend service
            const response = await axios.post(`${API_BASE_URL}/api/linkedin/generate-post`, {
                jobTitle,
                companyName,
                jobDescription,
                tone,
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm flex flex-col h-full">
            ...
            <div className="p-4 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-500">
                    Generate engaging job posts for LinkedIn using AI
                </p>
            </div>
